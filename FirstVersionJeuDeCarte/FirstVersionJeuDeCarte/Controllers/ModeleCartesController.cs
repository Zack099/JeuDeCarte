...
namespace JeuDeCarte.Controllers
{
    ...
    public class ModeleCartesController : ControllerBase
    {
        ...
        private static ModeleCarteDTO ItemToDTO(ModeleCarte todoItem) =>
    new ModeleCarteDTO
    {
        CardValue= todoItem.CardValue,
        CardCategory = todoItem.CardCategory,
        Remaining = todoItem.Remaining,
        Discarded = todoItem.Remaining,
        LastDiscarded = todoItem.LastDiscarded,
